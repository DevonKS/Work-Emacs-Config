...
(defcustom tfs/tf-exe  "C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\Common7\\IDE\\tf.exe"
  "location of the tf.exe command.  Defaults to \"C:\\Program Files (x86)\\Microsoft Visual Studio 14.0\\Common7\\IDE\\tf.exe\""
  :group 'tfs)

(defcustom tfs/tfpt-exe  "C:\\Program Files (x86)\\Microsoft Team Foundation Server 2015 Power Tools\\TFPT.EXE"
  "location of the tfpt.exe command.  Defaults to \"C:\\Program Files (x86)\\Microsoft Team Foundation Server 2015 Power Tools\\TFPT.EXE\""
  :group 'tfs)
